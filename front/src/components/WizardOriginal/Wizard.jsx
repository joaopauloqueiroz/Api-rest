...
class Wizard extends React.Component {
  ...
  refreshAnimation(index) {
    ...
    var movingTabStyle = {
      ...
      fontFamily: 'din-condensed,sans-serif', fontSize: '14px', fontWeight: 'bold'
    };
  ...
  render() {
    ...
    return (
      ...
      <GridContainer style={{}}>
        <div style={{width: '100%'}}>
        <img alt={'Voltar'} src={voltar} style={{width: '4vh',height: '4vh', position: 'absolute', left: '2.5%', marginTop: '1%', cursor: 'pointer', }} onClick={() => this.backPage()}/>
            <img alt={'Avançar'} src={voltar} style={{width: '4vh',height: '4vh', transform: 'rotate(180deg)', position: 'absolute', left: '95%', marginTop: '1%', cursor: 'pointer'}} onClick={() => this.nextPage()}/>
        </div>
      </GridContainer>
      <div className={classes.wizardContainer} ref="wizard">
        <Card className={classes.card} style={{boxShadow: '0 1px 1px 1px rgba(8, 27, 49, 0.10), 0 1px 1px -2px rgba(8, 27, 49, 0.4)', borderRadius: '0px', marginTop: '8vh'}}>
              ...
              {steps.map((prop, key) => {
                return (
                  <li
                    ...
                    key={key}
                    style={{ width: this.state.width, ontFamily: 'din-condensed,sans-serif', fontSize: '14px', fontWeight: 'bold'}}
                  >
                    <a
                    style={{ fontFamily: 'din-condensed,sans-serif', fontSize: '14px', fontWeight: 'bold'}}
          ...
          <div className={classes.content} style={{marginTop:'-33px'}}>
            {steps.map((prop, key) => {
